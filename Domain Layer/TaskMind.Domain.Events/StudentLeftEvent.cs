...
{
    /// <summary>Phát sinh khi một Student rời cơ sở đào tạo — bản ghi đóng băng VĨNH VIỄN, không tái kích hoạt (mục 2.1.1). [MỚI - v2.1]</summary>
    public class StudentLeftEvent : DomainEvent
    {
